...
namespace AlternateLife.RageMP.Net.Interfaces
{
    public interface IMarkerPool : IPool<IMarker>
    {
        ...
        IMarker New(MarkerType type, Vector3 position, Vector3 rotation, Vector3 direction, float scale, Color color, bool visible, uint dimension = RageMpConsts.GlobalDimension);
    }
}
