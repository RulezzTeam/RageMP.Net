...
namespace AlternateLife.RageMP.Net.Interfaces
{
    public interface ITextLabelPool : IPool<ITextLabel>
    {
        ...
        ITextLabel New(Vector3 position, string text, TextFontStyle font, Color color, float drawDistance = 20, bool los = false, uint dimension = RageMpConsts.GlobalDimension);
    }
}
